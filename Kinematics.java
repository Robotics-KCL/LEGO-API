...
public class Kinematics {
	...
	public UltrasonicSensor detector;
	...
	public Kinematics(){
		...
		detector = new UltrasonicSensor(SensorPort.S1);
	...
	/**
	 * Sonar used to detect plants
	 * @return
	 */
	public int getDetectionSonar(){
		return detector.getDistance();
	}
